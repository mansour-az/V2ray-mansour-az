# Venzo VPN for Windows 2.5.1 — Product Specification
...
- Graphite/red/silver three-column desktop shell matching approved design 1.
- One-click smart connection, fastest-server rail and live connection timer.
